...
(function () {
    ...
    function renderProjectCard(project, index) {
        // Ultra-simple approach - just use div with onclick
        const detailUrl = `project-template.html?project=${project.slug}`;
        return `
            <div class="project-card" onclick="window.location.href='${detailUrl}';" style="cursor: pointer;">
                <img 
                ...
                <div class="project-card__overlay">
                    <span class="project-card__type">${getTypeLabel(project.type)}</span>
    ...
    function renderProjectGrid() {
        ...
        // Click handlers removed - using native anchor tags
    ...
    // Function attachCardHandlers removed - using native <a> tags
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (isListingPage) {
            ...
            // Wait for projects to load from Firestore before initializing detail page
            if (PROJECTS.length > 0) {
                initProjectDetail();
                setupLightbox();
                setupLazyLoading();
            } else {
                // Wait for projectsLoaded event
